...
// ############################################################################################################
// ########################  Dijkstra's Weighted Source Shortest Path  ########################################
// ############################################################################################################
...
CALL apoc.export.csv.query(query, "Neo4j/exports/2b/dijkstras_weighted_source_shortest_path.csv", {})
YIELD file, source, format, nodes, relationships, properties, time, rows, batchSize, batches, done, data
RETURN file, source, format, nodes, relationships, properties, time, rows, batchSize, batches, done, data;


// ############################################################################################################
// ########################  Bellman-Ford's Weighted Source Shortest Path  ####################################
// ############################################################################################################
...
RETURN
    ...
    Path
ORDER BY TotalCost ASC" AS query
CALL apoc.export.csv.query(query, "Neo4j/exports/2b/bellman_fords_weighted_source_shortest_path.csv", {})
YIELD file, source, format, nodes, relationships, properties, time, rows, batchSize, batches, done, data
RETURN file, source, format, nodes, relationships, properties, time, rows, batchSize, batches, done, data;


// ############################################################################################################
// ########################  Delta-Stepping Weighted Source Shortest Path  ####################################
// ############################################################################################################
...
RETURN
    ...
    Path
ORDER BY TotalCost ASC" AS query
CALL apoc.export.csv.query(query, "Neo4j/exports/2b/delta_stepping_weighted_source_shortest_path.csv", {})
YIELD file, source, format, nodes, relationships, properties, time, rows, batchSize, batches, done, data
RETURN file, source, format, nodes, relationships, properties, time, rows, batchSize, batches, done, data;


// ############################################################################################################
// ########################  Weighted Source-Target Shortest Path  ############################################
// ############################################################################################################
...
// ############################################################################################################
// ########################  Dijkstra's Weighted Source-Target Shortest Path  #################################
// ############################################################################################################
...
RETURN
    ...
    Path
ORDER BY TotalCost ASC" AS query
CALL apoc.export.csv.query(query, "Neo4j/exports/2b/dijkstras_weighted_source_target_shortest_path.csv", {})
YIELD file, source, format, nodes, relationships, properties, time, rows, batchSize, batches, done, data
RETURN file, source, format, nodes, relationships, properties, time, rows, batchSize, batches, done, data;


// ############################################################################################################
// ########################  Bellman-Ford's Weighted Source-Target Shortest Path  #############################
// ############################################################################################################
...
RETURN
    ...
    Path
ORDER BY TotalCost ASC" AS query
CALL apoc.export.csv.query(query, "Neo4j/exports/2b/bellman_fords_weighted_source_target_shortest_path.csv", {})
YIELD file, source, format, nodes, relationships, properties, time, rows, batchSize, batches, done, data
RETURN file, source, format, nodes, relationships, properties, time, rows, batchSize, batches, done, data;


// ############################################################################################################
// ########################  Yen's Weighted Source-Target Shortest Path  ######################################
// ############################################################################################################
...
RETURN
    ...
    Path
ORDER BY TotalCost ASC" AS query
CALL apoc.export.csv.query(query, "Neo4j/exports/2b/yens_ weighted_source_target_shortest_path.csv", {})
YIELD file, source, format, nodes, relationships, properties, time, rows, batchSize, batches, done, data
RETURN file, source, format, nodes, relationships, properties, time, rows, batchSize, batches, done, data;

// ############################################################################################################
// ########################  Delta-Stepping Weighted Source-Target Shortest Path  #############################
// ############################################################################################################
...
RETURN
    ...
    Path
ORDER BY TotalCost ASC" AS query
CALL apoc.export.csv.query(query, "Neo4j/exports/2b/delta_stepping_weighted_source_target_shortest_path.csv", {})
YIELD file, source, format, nodes, relationships, properties, time, rows, batchSize, batches, done, data
RETURN file, source, format, nodes, relationships, properties, time, rows, batchSize, batches, done, data;